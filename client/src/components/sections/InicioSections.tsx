      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center dark-image">
          <div className="w-full lg:w-1/2 space-y-8 text-white">
            ...
            <p className="max-w-xl text-base leading-7 text-zinc-300 lg:text-lg">Si quieres una web, una marca o una experiencia visual con mejor criterio, mejor ritmo y más percepción de valor, empecemos por una conversación clara.</p>
            ...
            <p className="text-sm text-zinc-500">Consulta sin costo • respuesta en 24h</p>
          </div>
